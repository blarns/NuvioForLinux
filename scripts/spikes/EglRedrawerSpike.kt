// An EGL Redrawer for skiko — the one piece of the mpv plan with no spike behind it.
//
// Everything else is proven (see MPV_SWAP_SCOPING.md "Revision 2026-08-16b"):
// shipped skiko rasterises on EGL via makeGLWithInterface, mpv hardware-decodes
// zero-copy on that same context, and Skia adopts its texture. But every one of
// those spikes used eglMakeCurrent(..., EGL_NO_SURFACE, ...) against an FBO.
// A real Compose window needs a *window* surface on the AWT component's X11
// window, driven through skiko's Redrawer lifecycle. That is this file.
//
// Standalone on purpose: app source stays untouched until this renders.
//
