...
// Desktop (JVM) plugin crypto. Upstream declares these per-platform rather than via
// expect/actual, and its Android implementation is pure JVM (java.security / javax.crypto)
// with no Android APIs — so this is that file verbatim, kept in sync with it.
